...
\begin{itemize}[leftmargin=*]
    ...
    \item \textbf{Step 3: Analyze AST to Detect Code Smells}: To enable this
        ...
        % shows the detection metrics with default thresholds for each code smell.
        % Finally, \texttt{TreeNose} generates reports with the list of code
        % smells detected in the project.
        ...
        % \texttt{TreeNose} to execute the same
