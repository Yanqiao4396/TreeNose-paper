...
% After building the confidence on the performance of \texttt{TreeNose}, we
% utilized \texttt{TreeNose} to analyze the structural patterns of the selected
% code smells, i.e., distribution and prevalence, in the different programming
% languages. To achieve so, we implemented \texttt{TreeNose} in at least 15
% open-source projects, including ones written in the combination of the selected
% languages.
...
\begin{itemize}[leftmargin=*]
    ...
    \item {\it RQ1: How does \texttt{TreeNose} perform in different languages?}
        ...
        and the F1 score for both \texttt{TreeNose} and popular
