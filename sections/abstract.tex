\begin{abstract}
    ...
    between 35\% and 55\% of the detected code smells.
    %
    The results also showed that Long Method smells make up 37\% of all those
    detected for JavaScript programs and Long Class code smells constitute 26\% of
