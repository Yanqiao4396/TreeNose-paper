...
new ones, we investigated the characteristics of code smells in different
...
We also found that (i) Complex Conditional accounts for 42\% of the total code
...
other systems; (iii) multi-language projects have more evenly distributed code
smells than single-language ones.
%
